...
Here:
- 3.1 Node Constraints: value set - picklist of URIs
...
def test_csv_to_dict(capsys):
    ...
    my:IssueShape , ex:state   , ex:assigned ex.unassigned , picklist
    """
    #
    # fmt: on
    expected_dict = {
        ...
        "shapes": [
            {
                ...
                "statement_templates": [
                    {
                        "propertyID": "ex:state",
                        "valueConstraint": ["ex:assigned", "ex:unassigned"],
    ...
    first_actual_st = actual_dict["shapes"][0]["statement_templates"][0]
    first_expected_st = expected_dict["shapes"][0]["statement_templates"][0]
    # assert actual_dict == expected_dict
    # with capsys.disabled():
    #     from pprint import pprint
    #     print()
    #     pprint(actual_dict["shapes"][0]["statement_templates"][0])
